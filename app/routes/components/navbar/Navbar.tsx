...
export default function Navbar() {
    return (
        <div className='w-screen h-[75px] z-10 bg-smooth-blue'>
            <div className='px-2 flex justify-between items-center w-full h-full'>
                ...
                <div className="flex items-center">
                    ...
                    <div className="flex w-[130px] h-[130px] bg-smooth-blue items-center rounded-3xl justify-center mt-12 mr-10">
