...
function Index() {
  ...
  connection.query("INSERT INTO Anime (id, slug, synopsis, abbreviated_titles, start_date, end_date, rating_rank, subtype, status, poster_image, cover_image, episode_count) VALUES (?, ?)", [data.id, data.slug, data.description, data.startDate, data.endDate, data.averageRatingRank, data.subtype, data.status, data.posterImage.original.url, data.bannerImage.original.url, data.episodeCount], function(error3, results) {
    if (error3) {
...
//# sourceMappingURL=/build/routes/index-VXEXBYTQ.js.map
