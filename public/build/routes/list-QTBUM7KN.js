...
function List() {
  ...
  }, "What is your name?"), /* @__PURE__ */ React.createElement("span", {
    className: "label-text-alt"
  }, "Alt label")), /* @__PURE__ */ React.createElement("input", {
    type: "text",
    placeholder: "Type here",
    className: "input input-bordered w-full max-w-xs"
  }, "idk"), /* @__PURE__ */ React.createElement("label", {
    className: "label"
  }, /* @__PURE__ */ React.createElement("span", {
    className: "label-text-alt"
  }, "Alt label"), /* @__PURE__ */ React.createElement("span", {
    className: "label-text-alt"
  }, "Alt label"))));
}
export {
...
//# sourceMappingURL=/build/routes/list-QTBUM7KN.js.map
